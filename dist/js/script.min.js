...
let barsMobile = document.querySelector(".bars_mobile"),
  xMobile = document.querySelector(".x_mobile"),
  ulDisplayNone = document.querySelector(".ul_display_none"),
  navMobileItems = document.querySelectorAll(".nav-mobile-item"),
  ...
  clickNavMobileItems =
    ...
    () => {
      navMobileItems.forEach((e) => {
        e.addEventListener("click", hidenNavMobile);
      });
    });
clickNavMobileItems();
...
const cookies = () => {
  if (
    ...
    "true" !== localStorage.getItem("cookiesShown")
  ) {
    let e = document.body;
    var i = document.createElement("div");
    e.appendChild(i), i.classList.add("cookies");
    let o = document.querySelector(".cookies");
    (o.innerHTML = `
  <p>Ciasteczka</p>
  ...
  `),
      (o.style =
        "position: fixed; bottom:0;  width:100%; height:100vh; background-color:rgba(0,0,0,0.8); display: flex; justify-content:center; align-items:center; flex-direction:column; color:white; z-index:1; scrollBehavior: smooth;");
    i = document.querySelector(".cookieX");
    (i.style = " cursor:pointer; font-size:3rem; margin:1rem"),
      ...
      document.querySelectorAll(".cookies p").forEach((e) => {
        e.style =
          "margin:1rem; font-size:1.5rem; border: 1px solid white; padding:1rem; border-radius:1rem; box-shadow: 0 2px 5px white;";
      });
  }
};
cookies(),
  email.addEventListener("click", () => {
    email.value.includes("@") && email.value.includes(".") && console.log("ok");
  });
